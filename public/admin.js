...
/* ======= Ergänzung: Table spacing responsive fixes (append after previous patch) ======= */

/* Desktop: force fixed layout to avoid column collapse and reduce vertical cramping */
@media (min-width: 992px) {
  .table-container table {
    table-layout: fixed; /* يمنع التحول الغير متوقع لأعمدة الجدول */
    min-width: 0;        /* نتأكد انه ما يجبر الجدول على اتساع زائد */
  }
  /* نوزع الأعمدة بشكل ثابت مع إمكانية الكسر داخل الخلايا */
  .table-container th, .table-container td {
    padding: 0.45rem 0.6rem; /* أقل من المحمول ليريح الصفوف */
    overflow: hidden;
    text-overflow: ellipsis;
  }
  /* أعمدة محددة للعناوين المهمة حتى ما تتصرف بشكل عشوائي */
  .table-container th:nth-child(1), .table-container td:nth-child(1) { width: 14%; min-width: 110px; }
  .table-container th:nth-child(2), .table-container td:nth-child(2) { width: 20%; min-width: 150px; }
  .table-container th:nth-child(3), .table-container td:nth-child(3) { width: 18%; min-width: 130px; }
  .table-container th:nth-child(4), .table-container td:nth-child(4) { width: 12%; min-width: 90px; }
  .table-container th:nth-child(5), .table-container td:nth-child(5) { width: 12%; min-width: 90px; text-align: right; }
  .table-container th:nth-child(6), .table-container td:nth-child(6) { width: 14%; min-width: 110px; }
  .table-container th:nth-child(7), .table-container td:nth-child(7) { width: 10%; min-width: 90px; text-align: center; }

  /* نضمن ان العناصر داخل الخلايا تنكسر بدل ما تتراكب */
  .table-container td * { display: inline-block; max-width: 100%; white-space: normal; word-break: break-word; }
}

/* Tablet & mobile: اجعل الجدول يتصرف طبيعي ويقلل الفراغ الكبير */
@media (max-width: 991px) {
  .table-container {
    padding: 0.4rem; /* يقلل الفراغ حول الجدول */
  }
  .table-container table {
    min-width: 100%;  /* يمشي مع عرض الحاوية بدل ما يوسع برة */
    table-layout: auto;
  }
  .table-container th, .table-container td {
    padding: 0.5rem 0.6rem; /* متوازن على الموبايل */
  }
  /* لو كان في فراغ كبير بين الصفوف نخلي ارتفاعهم أضيق */
  .table-container tbody tr { padding: 0.25rem 0; margin: 0.25rem 0; }

  /* تصغير تباعد الأزرار على الموبايل */
  .action-buttons button { padding: 0.32rem 0.45rem; min-height: 34px; font-size: 0.95rem; }
}

/* Fix: لو في سطور طويلة جداً داخل الخلايا (روابط أو كلمات) نعطيهم فاصل كلمات ذكي */
.table-container td a, .table-container td span, .table-container td p {
  overflow-wrap: break-word;
  word-break: break-word;
}

/* إذا ظل السهم (caret) مغطى أو مش ظاهر نخفف overflow في ال wrapper */
.status-select-wrapper { overflow: visible; }

/* تحسين بصري طفيف: فصل افتراضي بين الصفوف بدل الالتصاق المتكرر اللي ظهر بالصورة */
.table-container tbody tr + tr { border-top: 1px solid rgba(0,0,0,0.03); }
