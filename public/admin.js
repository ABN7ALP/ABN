...
// ==========================================
// 🎯 دوال جديدة للتصميم المحسن
// ==========================================

// تهيئة شريط التنقل
function initNavigation() {
    // التنقل الناعم بين الأقسام
...
function updateHeaderForAuth() {
    ...
    if (userInfo && userInfo._id) {
        authContainer.innerHTML = `
            <div class="user-dropdown-header">
                ...
                <div class="user-dropdown-menu">
                    ...
                    <button id="header-logout-btn" class="logout-link"><i class="ph-bold ph-sign-out"></i> تسجيل الخروج</button>
                </div>
            </div>
        `;
        ...
        authContainer.innerHTML = `
            <button class="header-action-btn" id="header-login-btn">
...
// تهيئة الأزرار الجديدة
function initNewButtons() {
    // زر شحن الرصيد في الهيدر
    ...
    document.getElementById('hero-video-btn')?.addEventListener('click', () => {
        alert('🚧 الفيديو التعريفي قيد التطوير\nسيتم إضافته قريباً!');
    });
    
    // زر ابدأ الآن في قسم CTA
    ...
    // زر تواصل مع الدعم
    document.getElementById('cta-contact-btn')?.addEventListener('click', () => {
    ...
    document.getElementById('floating-chat')?.addEventListener('click', () => {
        alert('🚧 نظام المحادثة المباشرة قيد التطوير\nتواصل معنا على الواتساب حالياً!');
    });
    
    // زر العودة للأعلى
    document.getElementById('floating-scroll-top')?.addEventListener('click', () => {
        window.scrollTo({ top: 0, behavior: 'smooth' });
    });
}

// مراقبة التمرير للأزرار العائمة
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // تحديث الهيدر عند تغيير حالة المصادقة
